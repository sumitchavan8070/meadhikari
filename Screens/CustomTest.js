...
const CustomTestPage = () => {
  ...
  const handleShareTest = async () => {
    if (
      selectedQuestions.length < minQueLimit ||
      selectedQuestions.length > maxQueLimit
    ) {
  ...
  <div class="container box-template"> <!-- Added box-template class here -->
      ...
      <div class="question-paper-heading">Prepared By : <span class="question-paper-heading-text">${preparedBy}</span></div>
      <div class="question-paper-heading">Test Name : <span class="question-paper-heading-text">${questionPaperName}</span></div>
      ...
      <div>
        ...
        <ul>${question.options
          .map(
            (option, optionIndex) => `
          <li>Option ${optionIndex + 1}: ${option}</li>`
          )
          .join("")}</ul>
        <hr />
      </div>
                  ...
                  >
                    <TouchableOpacity
                      onPress={() => {
                        if (selectedQuestions.length === 0) {
                          Alert.alert(
                            "Please add questions as per instructions"
                          );
                          return;
                        }
                        togglePreviewModal();
                  ...
                  {selectedQuestions.length === 0 ? (
                    <>
                      ...
                      >
                        ...
                        <Text>
                          3. You can combine your questions with ours.
                        </Text>
                        <View
                          style={{
                            padding: 20,
            ...
            {subActiveTab === "list" && (
              <ScrollView style={styles.questionBox}>
                ...
                {questionPaperData.length === 0 ? (
                  <>
                    <Text style={styles.noQuestionsText}>
                      You can add questions from exam, subject and topic
                    </Text>
